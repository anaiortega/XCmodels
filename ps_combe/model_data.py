...
polT4= geom.Poligono2d([geom.Pos2d(0.23,0.0), geom.Pos2d(0.23,0.1), geom.Pos2d(0.06,0.14), geom.Pos2d(0.06,0.52), geom.Pos2d(0.35,0.55), geom.Pos2d(0.35,0.65), geom.Pos2d(-0.645,0.65), geom.Pos2d(-0.645,0.59), geom.Pos2d(-0.06,0.52), geom.Pos2d(-0.06,0.14), geom.Pos2d(-0.23,0.1), geom.Pos2d(-0.23,0.0), geom.Pos2d(-0.025,0.0), geom.Pos2d(-0.025,0.03), geom.Pos2d(0.025,0.03), geom.Pos2d(0.025,0.0), geom.Pos2d(0.23,0.0)])
polT5= geom.Poligono2d([geom.Pos2d(0.23,0.0), geom.Pos2d(0.23,0.1), geom.Pos2d(0.06,0.14), geom.Pos2d(0.06,0.52), geom.Pos2d(0.645,0.59), geom.Pos2d(0.645,0.65), geom.Pos2d(-0.35,0.65), geom.Pos2d(-0.35,0.55), geom.Pos2d(-0.06,0.52), geom.Pos2d(-0.06,0.14), geom.Pos2d(-0.23,0.1), geom.Pos2d(-0.23,0.0), geom.Pos2d(-0.025,0.0), geom.Pos2d(-0.025,0.03), geom.Pos2d(0.025,0.03), geom.Pos2d(0.025,0.0), geom.Pos2d(0.23,0.0)])
polT6= geom.Poligono2d([geom.Pos2d(0.23,0.0), geom.Pos2d(0.23,0.1), geom.Pos2d(0.06,0.14), geom.Pos2d(0.06,0.52), geom.Pos2d(0.645,0.59), geom.Pos2d(0.645,0.65), geom.Pos2d(-0.645,0.65), geom.Pos2d(-0.645,0.59), geom.Pos2d(-0.06,0.52), geom.Pos2d(-0.06,0.14), geom.Pos2d(-0.23,0.1), geom.Pos2d(-0.23,0.0), geom.Pos2d(0.23,0.0)])

beamType4Section= section_properties.PolygonalSection('beamType4Contour',geom.Poligono2d(polT4)).defElasticShearSection3d(preprocessor,typical_materials.MaterialData('tmp',beamConcr.Ecm(),beamConcr.nuc,beamConcr.density()))
beamType5Section= section_properties.PolygonalSection('beamType5Contour',geom.Poligono2d(polT5)).defElasticShearSection3d(preprocessor,typical_materials.MaterialData('tmp',beamConcr.Ecm(),beamConcr.nuc,beamConcr.density()))
beamType6Section= section_properties.PolygonalSection('beamType6Contour',geom.Poligono2d(polT6)).defElasticShearSection3d(preprocessor,typical_materials.MaterialData('tmp',beamConcr.Ecm(),beamConcr.nuc,beamConcr.density()))
