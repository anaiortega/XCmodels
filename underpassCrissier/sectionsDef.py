...
FoundExtSlabRCSect= element_section_map.RCSlabBeamSection(name='foundExtSlabRCSect',sectionDescr="underpass.",concrType=concrete, reinfSteelType=reinfSteel,depth=0.60)
...
FoundIntSlabRCSect= element_section_map.RCSlabBeamSection('foundIntSlabRCSect',"underpass.",concrete, reinfSteel,0.60)
#[0]: transversal rebars
#[1]: longitudinal rebars
...
LeftWallRCSect= element_section_map.RCSlabBeamSection('leftWallRCSect',"underpass.",concrete, reinfSteel,0.45)
#[0]: horizontal rebars
#[1]: vertical rebars
...
RightWallRCSect= element_section_map.RCSlabBeamSection('rightWallRCSect',"underpass.",concrete, reinfSteel,0.45)
#[0]: horizontal rebars
#[1]: vertical rebars
...
DeckExtSlabRCSect= element_section_map.RCSlabBeamSection('deckExtSlabRCSect',"underpass.",concrete, reinfSteel,0.35)
#[0]: transversal rebars
#[1]: longitudinal rebars
...
DeckIntSlabRCSect= element_section_map.RCSlabBeamSection('deckIntSlabRCSect',"underpass.",concrete, reinfSteel,0.35)
#[0]: transversal rebars
#[1]: longitudinal rebars
