...
diagArea=1
diagRint=0  #internal radius [m]
diagRext=math.sqrt(diagArea/math.pi)      #external radius [m]
...
saddArea=1                  
saddRint=0  #internal radius [m]
saddRext=math.sqrt(saddArea/math.pi)      #external radius [m]
...
diagSect=section_properties.CircularSection(name='diagSect',Rext=diagRext,Rint=diagRint)
saddSect=section_properties.CircularSection(name='saddSect',Rext=saddRext,Rint=saddRint)
...
#cables materials
diagCableMat=typical_materials.defElasticSection3d(preprocessor=prep,name='diagCableMat',A=diagSect.A(),E=EdiagCable,G=Gstruts,Iz=diagSect.Iz(),Iy=diagSect.Iy(),J=diagSect.J())
saddCableMat=typical_materials.defElasticSection3d(preprocessor=prep,name='saddCableMat',A=saddSect.A(),E=EsaddCable,G=Gstruts,Iz=saddSect.Iz(),Iy=saddSect.Iy(),J=saddSect.J())
...
seedElemHandler.defaultTag= 1 
diagTruss= seedElemHandler.newElement("ElasticBeam3d",xc.ID([0,0]))
...
# ****
    constr.newSPConstraint(n.tag,0,0.0) # ux=0
    constr.newSPConstraint(n.tag,1,0.0) # uy=0
# ****
