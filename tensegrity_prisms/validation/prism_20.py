...
lcs.displayIntForcDiag(itemToDisp='N',setToDisplay=xcTotalSet.elSet,fConvUnits= 1.0e-3,scaleFactor=1.5e-3,unitDescription=': Axial internal forces [kN] ',viewName="XYZPos",hCamFct=1,fileName='plex_20.jpg',defFScale=40.0)
quit()
