...
lcs.displayIntForcDiag(itemToDisp='N',setToDisplay=xcTotalSet.elSet,fConvUnits= 1.0e-3,scaleFactor=1e-3,unitDescription=': Axial forces (kN)',viewName="XYPos",hCamFct=1,fileName='val_quad01.jpg',defFScale=25.0)
