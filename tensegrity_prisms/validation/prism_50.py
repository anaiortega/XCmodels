...
#Data
#    geometry
nSidPol=50     # number of sides of the regular n-polygon
...
lcs.displayIntForcDiag(itemToDisp='N',setToDisplay=xcTotalSet.elSet,fConvUnits= 1.0e-3,scaleFactor=1,unitDescription=': Axial internal forces [kN] ', viewDef=vtk_graphic_base.CameraParameters('XYZPos',1),fileName='plex-50.jpg',defFScale=40.0)
quit()
