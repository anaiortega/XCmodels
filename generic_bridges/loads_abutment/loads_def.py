...
if LaletaIzq>0:
    pnt1=gridGeomAbutment.getPntGrid((xListAbut.index(Xaleti[1]),yListAbut.index(Yaleti[1]),zListAbut.index(Zzap[0])))
    pnt2=gridGeomAbutment.getPntGrid((xListAbut.index(Xaleti[0]),yListAbut.index(Yaleti[1]),zListAbut.index(Zzap[0])))
    zGroundPnt1=zGround
    ...
    ep_aletIzq= loads.EarthPressLoad(name= 'ep_aletIzq', xcSet=aletIzq,soilData=soil_aletIzq, vDir=xc.Vector([-math.sin(ang),math.cos(ang),0]))
    G4_lstLoads.append(ep_aletIzq)
    
if LaletaDer>0:
    pnt1=gridGeomAbutment.getPntGrid((xListAbut.index(Xaletd[0]),yListAbut.index(Yaletd[1]),zListAbut.index(Zzap[0])))
    pnt2=gridGeomAbutment.getPntGrid((xListAbut.index(Xaletd[1]),yListAbut.index(Yaletd[1]),zListAbut.index(Zzap[0])))
    zGroundPnt1=zGround
    ...
    ep_aletDer= loads.EarthPressLoad(name= 'ep_aletDer', xcSet=aletDer,soilData=soil_aletDer, vDir=xc.Vector([-math.sin(ang),math.cos(ang),0]))
