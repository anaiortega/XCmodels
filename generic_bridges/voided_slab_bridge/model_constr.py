...
aux_rg=gut.def_rg_cooLim(XYZLists,(xAlmasAlig[0],xAlmasAlig[-1]),YriostrPil1,(zLosInf,zLosSup))
diafRP1_rg=aux_rg.extractIncludedIKranges()
aux_rg=gut.def_rg_cooLim(XYZLists,(xAlmasAlig[0],xAlmasAlig[-1]),YriostrPil2,(zLosInf,zLosSup))
diafRP2_rg=aux_rg.extractIncludedIKranges()

def rg_mur(Ycoor,Zcoor=ZmurAlig,Xmur=xAlmasAlig,xyzL=XYZLists):
    rg=list()
    for x in Xmur:
