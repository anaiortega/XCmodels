...
#Traffic load cases
Q1a1=slm.IAP_traffic_LC(lcName='Q1a1',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=centVFd_vano1,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,sidewalkSet=acerDer)
Q1a2=slm.IAP_traffic_LC(lcName='Q1a2',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=centVFd_vano2,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,sidewalkSet=acerDer)
Q1b1=slm.IAP_traffic_LC(lcName='Q1b1',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=centVFd_vano1,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,virtLane2Set=viaFictIzq,xyCentPL2=centVFi_vano1,restDrivewaySet=viaFictResto,sidewalkSet=aceras)
Q1b2=slm.IAP_traffic_LC(lcName='Q1b2',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=centVFd_vano2,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,virtLane2Set=viaFictIzq,xyCentPL2=centVFi_vano2,restDrivewaySet=viaFictResto,sidewalkSet=aceras)
Q1c=slm.IAP_traffic_LC(lcName='Q1c',deckSet=calzada,virtLane1Set=viaFictDer_vano2,xyCentPL1=centVFd_vano2,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,virtLane2Set=viaFictIzq_vano2,xyCentPL2=centVFi_vano2,restDrivewaySet=viaFictResto_vano2,sidewalkSet=aceras)
Q1d=slm.IAP_traffic_LC(lcName='Q1d',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=extrVFd_vano2,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,virtLane2Set=viaFictIzq,xyCentPL2=extrVFi_vano2,restDrivewaySet=viaFictResto,sidewalkSet=aceras)
Q1e=slm.IAP_traffic_LC(lcName='Q1e',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=extrVFd_vano1,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,virtLane2Set=viaFictIzq,xyCentPL2=extrVFi_vano1,restDrivewaySet=viaFictResto,sidewalkSet=aceras)

Q1bFren=slm.IAP_traffic_LC(lcName='Q1bFren',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=centVFd_vano1,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,vQbraking=vQfren,virtLane2Set=viaFictIzq,xyCentPL2=centVFi_vano1,restDrivewaySet=viaFictResto,sidewalkSet=aceras)
Q1dFren=slm.IAP_traffic_LC(lcName='Q1dFren',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=extrVFd_vano2,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,vQbraking=vQfren,virtLane2Set=viaFictIzq,xyCentPL2=extrVFi_vano2,restDrivewaySet=viaFictResto,sidewalkSet=aceras)
Q1eFren=slm.IAP_traffic_LC(lcName='Q1eFren',deckSet=calzada,virtLane1Set=viaFictDer,xyCentPL1=extrVFd_vano1,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,vQbraking=vQfren,virtLane2Set=viaFictIzq,xyCentPL2=extrVFi_vano1,restDrivewaySet=viaFictResto,sidewalkSet=aceras)
#Wind load cases
