...
Q1c=slm.IAP_traffic_LC(lcName='Q1c',deckSet=tablero,virtLane1Set=viaFictDer_vano2,xyCentPL1=centVFd_vano2,hDistrPL=cantoLosa/2.,slopeDistrPL=1.0,virtLane2Set=viaFictIzq_vano2,xyCentPL2=centVFi_vano2,restDrivewaySet=viaFictResto_vano2,sidewalkSet=aceras)
