...
zapEstrRCSects= element_section_map.RCSlabBeamSection(name='zapEstrRCSects',sectionDescr='zapata',concrType=concrete, reinfSteelType=reinfSteel,depth=cantoZap,elemSet=zapEstr)
...
#MURO ESTRIBO - ZONA 2
murEstrZ2RCSects= element_section_map.RCSlabBeamSection(name='murEstrZ2RCSects',sectionDescr='muro de estribo, zona Z2 ',concrType=concrete, reinfSteelType=reinfSteel,depth=espMurEstr,elemSet=murestrZ2)
#D1: vertical rebars
#D2: horizontal rebars
#positiv: exterior
#negativ: interior
...
#MURO ESTRIBO - ZONA 3
murEstrZ3RCSects= element_section_map.RCSlabBeamSection(name='murEstrZ3RCSects',sectionDescr='muro de estribo, zona Z3 ',concrType=concrete, reinfSteelType=reinfSteel,depth=espMurEstr,elemSet=murestrZ3)
#D1: vertical rebars
#D2: horizontal rebars
#positiv: exterior
#negativ: interior
...
if LaletaIzq>0:
    aletIzqZ1RCSects= element_section_map.RCSlabBeamSection(name='aletIzqZ1RCSects',sectionDescr='aleta izquierda, zona Z1 (inferior)',concrType=concrete, reinfSteelType=reinfSteel,depth=espAletiZ1,elemSet=aletiZ1)
    #D1: vertical rebars
    #D2: horizontal rebars
    #positiv: exterior
    #negativ: interior
    ...
    aletIzqZ2RCSects= element_section_map.RCSlabBeamSection(name='aletIzqZ2RCSects',sectionDescr='aleta izquierda, zona Z2',concrType=concrete, reinfSteelType=reinfSteel,depth=espAletiZ2,elemSet=aletiZ2)
    #D1: vertical rebars
    #D2: horizontal rebars
    #positiv: exterior
    #negativ: interior
    ...
    aletIzqZ3RCSects= element_section_map.RCSlabBeamSection(name='aletIzqZ3RCSects',sectionDescr='aleta izquierda, zona Z3',concrType=concrete, reinfSteelType=reinfSteel,depth=espAletiZ3,elemSet=aletiZ3)
...
if LaletaDer>0:
    aletDerZ1RCSects= element_section_map.RCSlabBeamSection(name='aletDerZ1RCSects',sectionDescr='aleta derecha, zona Z1 (inferior)',concrType=concrete, reinfSteelType=reinfSteel,depth=espAletdZ1,elemSet=aletdZ1)
    ...
    aletDerZ2RCSects= element_section_map.RCSlabBeamSection(name='aletDerZ2RCSects',sectionDescr='aleta derecha, zona Z2',concrType=concrete, reinfSteelType=reinfSteel,depth=espAletdZ2,elemSet=aletdZ2)
    ...
    aletDerZ3RCSects= element_section_map.RCSlabBeamSection(name='aletDerZ3RCSects',sectionDescr='aleta derecha, zona Z3',concrType=concrete, reinfSteelType=reinfSteel,depth=espAletdZ3,elemSet=aletdZ3)
