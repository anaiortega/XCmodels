...
zapEstrRCSects.dir1PositvRebarRows=[rcs.rebLayer_mm(trSup_zapEstr[0],trSup_zapEstr[1],rnomZap+lnSup_zapEstr[0][0])]
...
zapEstrRCSects.dir1NegatvRebarRows=[rcs.rebLayer_mm(trInf_zapEstr[0],trInf_zapEstr[1],rnomZap+lnInf_zapEstr[0][0])]
...
#horizontal exterior
murEstrZ1RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_murEstr[0][0],horzExt_murEstr[0][1],rnomMur+vertExt_murEstr[0][0][0])]
#vertical interior
...
#horizontal interior
murEstrZ1RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_murEstr[0][0],horzInt_murEstr[0][1],rnomMur+vertInt_murEstr[0][0][0])]
...
#horizontal exterior
murEstrZ2RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_murEstr[1][0],horzExt_murEstr[1][1],rnomMur+vertExt_murEstr[1][0][0])]
#vertical interior
...
#horizontal interior
murEstrZ2RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_murEstr[1][0],horzInt_murEstr[1][1],rnomMur+vertInt_murEstr[1][0][0])]
...
#horizontal exterior
murEstrZ3RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_murEstr[2][0],horzExt_murEstr[2][1],rnomMur+vertExt_murEstr[2][0][0])]
#vertical interior
...
#horizontal interior                
murEstrZ3RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_murEstr[2][0],horzInt_murEstr[2][1],rnomMur+vertInt_murEstr[2][0][0])]
...
if LaletaIzq>0:
    ...
    #positiv: exterior
    #negativ: interior
    aletIzqZ1RCSects.dir1PositvRebarRows=[rcs.rebLayer_mm(vertExt_aletIzq[0][0],vertExt_aletIzq[0][1],rnomMur)]
    aletIzqZ1RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_aletIzq[0][0],horzExt_aletIzq[0][1],rnomMur+vertExt_aletIzq[0][0])]
    aletIzqZ1RCSects.dir1NegatvRebarRows=[rcs.rebLayer_mm(vertInt_aletIzq[0][0],vertInt_aletIzq[0][1],rnomMur)]
    aletIzqZ1RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_aletIzq[0][0],horzInt_aletIzq[0][1],rnomMur+vertInt_aletIzq[0][0])]
    ...
    #positiv: exterior
    #negativ: interior
    aletIzqZ2RCSects.dir1PositvRebarRows=[rcs.rebLayer_mm(vertExt_aletIzq[1][0],vertExt_aletIzq[1][1],rnomMur)]
    aletIzqZ2RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_aletIzq[1][0],horzExt_aletIzq[1][1],rnomMur+vertExt_aletIzq[1][0])]
    aletIzqZ2RCSects.dir1NegatvRebarRows=[rcs.rebLayer_mm(vertInt_aletIzq[1][0],vertInt_aletIzq[1][1],rnomMur)]
    aletIzqZ2RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_aletIzq[1][0],horzInt_aletIzq[1][1],rnomMur+vertInt_aletIzq[1][0])]
    ...
    aletIzqZ3RCSects.dir1PositvRebarRows=[rcs.rebLayer_mm(vertExt_aletIzq[2][0],vertExt_aletIzq[2][1],rnomMur)]
    aletIzqZ3RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_aletIzq[2][0],horzExt_aletIzq[2][1],rnomMur+vertExt_aletIzq[2][0])]
    aletIzqZ3RCSects.dir1NegatvRebarRows=[rcs.rebLayer_mm(vertInt_aletIzq[2][0],vertInt_aletIzq[2][1],rnomMur)]
    aletIzqZ3RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_aletIzq[2][0],horzInt_aletIzq[2][1],rnomMur+vertInt_aletIzq[2][0])]
...
if LaletaDer>0:
    ...
    #positiv: exterior
    #negativ: interior
    aletDerZ1RCSects.dir1PositvRebarRows=[rcs.rebLayer_mm(vertExt_aletDer[0][0],vertExt_aletDer[0][1],rnomMur)]
    aletDerZ1RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_aletDer[0][0],horzExt_aletDer[0][1],rnomMur+vertExt_aletDer[0][0])]
    aletDerZ1RCSects.dir1NegatvRebarRows=[rcs.rebLayer_mm(vertInt_aletDer[0][0],vertInt_aletDer[0][1],rnomMur)]
    aletDerZ1RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_aletDer[0][0],horzInt_aletDer[0][1],rnomMur+vertInt_aletDer[0][0])]
    ...
    #positiv: exterior
    #negativ: interior
    aletDerZ2RCSects.dir1PositvRebarRows=[rcs.rebLayer_mm(vertExt_aletDer[1][0],vertExt_aletDer[1][1],rnomMur)]
    aletDerZ2RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_aletDer[1][0],horzExt_aletDer[1][1],rnomMur+vertExt_aletDer[1][0])]
    aletDerZ2RCSects.dir1NegatvRebarRows=[rcs.rebLayer_mm(vertInt_aletDer[1][0],vertInt_aletDer[1][1],rnomMur)]
    aletDerZ2RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_aletDer[1][0],horzInt_aletDer[1][1],rnomMur+vertInt_aletDer[1][0])]
    ...
    aletDerZ3RCSects.dir1PositvRebarRows=[rcs.rebLayer_mm(vertExt_aletDer[2][0],vertExt_aletDer[2][1],rnomMur)]
    aletDerZ3RCSects.dir2PositvRebarRows=[rcs.rebLayer_mm(horzExt_aletDer[2][0],horzExt_aletDer[2][1],rnomMur+vertExt_aletDer[2][0])]
    aletDerZ3RCSects.dir1NegatvRebarRows=[rcs.rebLayer_mm(vertInt_aletDer[2][0],vertInt_aletDer[2][1],rnomMur)]
    aletDerZ3RCSects.dir2NegatvRebarRows=[rcs.rebLayer_mm(horzInt_aletDer[2][0],horzInt_aletDer[2][1],rnomMur+vertInt_aletDer[2][0])]
