...
displayLocalAxes(setToDisplay=setParapet,vectorScale=0.3,viewDef= vtk_graphic_base.CameraParameters('XYZPos',2.0),caption= setParapet.genDescr.capitalize() + ', '+ capTexts['LocalAxes'],fileName=None)
