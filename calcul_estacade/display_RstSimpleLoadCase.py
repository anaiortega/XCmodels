...
for lc in loadCasesToDisplay:
    ...
    for st in lc.setsToDispDspRot:
        for arg in lc.listDspRot:
            if arg[0]=='u':
                ...
                fcUn=1.0
                unDesc=''
            lcs.displayDispRot(itemToDisp=arg,setToDisplay=st,fConvUnits=fcUn,unitDescription=unDesc,fileName=None)
    ...
    for st in lc.setsToDispIntForc:
        for arg in lc.listIntForc:
            ...
            lcs.displayIntForc(itemToDisp=arg,setToDisplay=st,fConvUnits= fcUn,unitDescription=unDesc,fileName=None)
    ...
    for st in lc.setsToDispBeamIntForc:
        for arg in lc.listBeamIntForc:
            ...
            lcs.displayIntForcDiag(itemToDisp=arg,setToDisplay=st,fConvUnits= fcUn,scaleFactor=scaleFact,unitDescription=unDescBeams,fileName=None)
