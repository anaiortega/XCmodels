...
model.display_local_axes(setToDisplay=cantlvSet.elSet,vectorScale=0.3,viewDef= vtk_graphic_base.CameraParameters('XYZPos',2.0),caption= cantlvSet.genDescr.capitalize() + ', '+ capTexts['LocalAxes'],fileName=None)
