...
setsDispRes=beamY   #set of linear elements to display results
...
qg.display_beam_result(attributeName=lsd.shearResistance.label,itemToDisp=argument,beamSetDispRes=setsDispRes,setToDisplay=setDisp,fConvUnits=fUnitConv,scaleFactor=1.0,caption=caption,viewDef= vtk_graphic_base.CameraParameters('XYZPos'),fileName=None,defFScale=0.0)
quit()
