...
wallRCSects= element_section_map.RCSlabBeamSection(name='wallRCSects',sectionDescr='wall of shell elements',concrType=concrete, reinfSteelType=reinfSteel,depth=wallTh,elemSet=wall)  
...
beamXRCsect=element_section_map.RCSlabBeamSection(name='beamXRCsect',sectionDescr='beam elements in X direction',concrType=concrete, reinfSteelType=reinfSteel,width=wbeamX,depth=hbeamX,elemSet=beamX)
...
beamYRCsect=element_section_map.RCSlabBeamSection(name='beamYRCsect',sectionDescr='beam elements in Y direction',concrType=concrete, reinfSteelType=reinfSteel,width=wbeamY,depth=hbeamY,elemSet=beamY)
...
columnZRCsect=element_section_map.RCSlabBeamSection(name='columnZRCsect',sectionDescr='columnZ',concrType=concrete, reinfSteelType=reinfSteel,width=wcolumnZ,depth=hcolumnZ,elemSet=columnZ)
