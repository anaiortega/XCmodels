...
Q1aEss=graphical_reports.LoadCaseDispParameters(loadCaseName='QtrafSit1aPoint',loadCaseDescr="Q1aEss: Modèle de charge 1 (fatigue), charge d'essieu en position Ia",loadCaseExpr='1.0*QtrafSit1aPoint',setsToDispLoads=[overallSet],setsToDispDspRot=[foundDeck,walls],setsToDispIntForc=[foundDeck,walls])
...
Q1bEss=graphical_reports.LoadCaseDispParameters(loadCaseName='QtrafSit1bPoint',loadCaseDescr="Q1bEss:Modèle de charge 1 (fatigue), charge d'essieu en position Ib",loadCaseExpr='1.0*QtrafSit1bPoint',setsToDispLoads=[overallSet],setsToDispDspRot=[foundDeck,walls],setsToDispIntForc=[foundDeck,walls])
...
Q2aEss=graphical_reports.LoadCaseDispParameters(loadCaseName='QtrafSit2aPoint',loadCaseDescr="Q2aEss: Modèle de charge 1 (fatigue), charge d'essieu en position IIa",loadCaseExpr='1.0*QtrafSit2aPoint',setsToDispLoads=[overallSet],setsToDispDspRot=[foundDeck,walls],setsToDispIntForc=[foundDeck,walls])
...
Q2bEss=graphical_reports.LoadCaseDispParameters(loadCaseName='QtrafSit2bPoint',loadCaseDescr="Q2bEss: Modèle de charge 1 (fatigue), charge d'essieu en position IIb",loadCaseExpr='1.0*QtrafSit2bPoint',setsToDispLoads=[overallSet],setsToDispDspRot=[foundDeck,walls],setsToDispIntForc=[foundDeck,walls])
...
Q3=graphical_reports.LoadCaseDispParameters(loadCaseName='QtrafExcept',loadCaseDescr='Q3: Modèle de charge transport exceptionnel',loadCaseExpr='1.0*QQtrafExcept',setsToDispLoads=[overallSet],setsToDispDspRot=[foundDeck,walls],setsToDispIntForc=[foundDeck,walls])
