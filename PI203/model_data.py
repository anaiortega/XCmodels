...
leftDownWall=gridGeom.genSurfMultiRegion(lstIJKRange=leftDownWall_rg,nameSet='leftDownWall')
leftUpWall=gridGeom.genSurfMultiRegion(lstIJKRange=leftUpWall_rg,nameSet='leftUpWall')
rightDownWall=gridGeom.genSurfMultiRegion(lstIJKRange=rightDownWall_rg,nameSet='rightDownWall')
rightUpWall=gridGeom.genSurfMultiRegion(lstIJKRange=rightUpWall_rg,nameSet='rightUpWall')
midWall=gridGeom.genSurfMultiRegion(lstIJKRange=midWall_rg,nameSet='midWall')
upDeckExtSlab=gridGeom.genSurfMultiRegion(lstIJKRange=upDeckExtSlab_rg,nameSet='upDeckExtSlab')
upDeckIntSlab=gridGeom.genSurfMultiRegion(lstIJKRange=upDeckIntSlab_rg,nameSet='upDeckIntSlab')
downDeckExtSlab=gridGeom.genSurfMultiRegion(lstIJKRange=downDeckExtSlab_rg,nameSet='downDeckExtSlab')
downDeckIntSlab=gridGeom.genSurfMultiRegion(lstIJKRange=downDeckIntSlab_rg,nameSet='downDeckIntSlab')
...
selfWeight= loads.InertialLoad(name='selfWeight', lstMeshSets=allSurfList, vAccel=xc.Vector( [0.0,0.0,-grav]))
