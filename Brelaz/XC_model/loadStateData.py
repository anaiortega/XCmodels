...
'''
G1=graphical_reports.RecordLoadCaseDisp(loadCaseName='GselfWeight',loadCaseDescr='G1: self weight',loadCaseExpr='1.0*GselfWeight',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
G2=graphical_reports.RecordLoadCaseDisp(loadCaseName='GdeadLoad',loadCaseDescr='G2: dead load',loadCaseExpr='1.0*GdeadLoad',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QA=graphical_reports.RecordLoadCaseDisp(loadCaseName='QliveLoadA',loadCaseDescr='QA: live load A',loadCaseExpr='1.0*QliveLoadA',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QB=graphical_reports.RecordLoadCaseDisp(loadCaseName='QliveLoadB',loadCaseDescr='QB: live load B',loadCaseExpr='1.0*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QF=graphical_reports.RecordLoadCaseDisp(loadCaseName='QfatigueLoad',loadCaseDescr='QF: fatigue load',loadCaseExpr='1.0*QfatigueLoad',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QAcc=graphical_reports.RecordLoadCaseDisp(loadCaseName='Qaccidental',loadCaseDescr='QAcc: accidental',loadCaseExpr='1.0*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
# ULS
ULS_A=graphical_reports.RecordLoadCaseDisp(loadCaseName='ULS_A',loadCaseDescr='ULS_A: ultimate limit state A',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadA',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
ULS_B=graphical_reports.RecordLoadCaseDisp(loadCaseName='ULS_B',loadCaseDescr='ULS_B: ultimate limit state B',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
ULS_Acc=graphical_reports.RecordLoadCaseDisp(loadCaseName='ULS_Acc',loadCaseDescr='ULS_Acc: ultimate limit state Accidental',loadCaseExpr='1.00*GselfWeight+1.00*GdeadLoad+1.00*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
