...
'''
G1=graphical_reports.LoadCaseDispParameters(loadCaseName='GselfWeight',loadCaseDescr='G1: self weight',loadCaseExpr='1.0*GselfWeight',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
G2=graphical_reports.LoadCaseDispParameters(loadCaseName='GdeadLoad',loadCaseDescr='G2: dead load',loadCaseExpr='1.0*GdeadLoad',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QA=graphical_reports.LoadCaseDispParameters(loadCaseName='QliveLoadA',loadCaseDescr='QA: live load A',loadCaseExpr='1.0*QliveLoadA',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QB=graphical_reports.LoadCaseDispParameters(loadCaseName='QliveLoadB',loadCaseDescr='QB: live load B',loadCaseExpr='1.0*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QF=graphical_reports.LoadCaseDispParameters(loadCaseName='QfatigueLoad',loadCaseDescr='QF: fatigue load',loadCaseExpr='1.0*QfatigueLoad',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
QAcc=graphical_reports.LoadCaseDispParameters(loadCaseName='Qaccidental',loadCaseDescr='QAcc: accidental',loadCaseExpr='1.0*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
# ULS
ULS_A=graphical_reports.LoadCaseDispParameters(loadCaseName='ULS_A',loadCaseDescr='ULS_A: ultimate limit state A',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadA',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
ULS_B=graphical_reports.LoadCaseDispParameters(loadCaseName='ULS_B',loadCaseDescr='ULS_B: ultimate limit state B',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
ULS_Acc=graphical_reports.LoadCaseDispParameters(loadCaseName='ULS_Acc',loadCaseDescr='ULS_Acc: ultimate limit state Accidental',loadCaseExpr='1.00*GselfWeight+1.00*GdeadLoad+1.00*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deck])
...
#For loads display
QA_unif=graphical_reports.LoadCaseDispParameters(loadCaseName='QliveLoadA_unif',loadCaseDescr='QA: live load A_unif',loadCaseExpr='1.0*QliveLoadA_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
QA_unif.unitsScaleLoads=1e-3

QB_unif=graphical_reports.LoadCaseDispParameters(loadCaseName='QliveLoadB_unif',loadCaseDescr='QB: live load B_unif',loadCaseExpr='1.0*QliveLoadB_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
QB_unif.unitsScaleLoads=1e-3

QF_unif=graphical_reports.LoadCaseDispParameters(loadCaseName='QfatigueLoad_unif',loadCaseDescr='QF: fatigue load_unif',loadCaseExpr='1.0*QfatigueLoad_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
QF_unif.unitsScaleLoads=1e-3


QAcc_unif=graphical_reports.LoadCaseDispParameters(loadCaseName='Qaccidental_unif',loadCaseDescr='QAcc: accidental_unif',loadCaseExpr='1.0*Qaccidental_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
QAcc_unif.unitsScaleLoads=1e-3

QA_point=graphical_reports.LoadCaseDispParameters(loadCaseName='QliveLoadA_point',loadCaseDescr='QA: live load A_point',loadCaseExpr='1.0*QliveLoadA_point',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
QA_point.unitsScaleLoads=1e-3

QB_point=graphical_reports.LoadCaseDispParameters(loadCaseName='QliveLoadB_point',loadCaseDescr='QB: live load B_point',loadCaseExpr='1.0*QliveLoadB_point',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
QB_point.unitsScaleLoads=1e-3

QF_point=graphical_reports.LoadCaseDispParameters(loadCaseName='QfatigueLoad_point',loadCaseDescr='QF: fatigue load_point',loadCaseExpr='1.0*QfatigueLoad_point',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
QF_point.unitsScaleLoads=1e-3

QAcc_point=graphical_reports.LoadCaseDispParameters(loadCaseName='Qaccidental_point',loadCaseDescr='QAcc: accidental_point',loadCaseExpr='1.0*Qaccidental_point',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
