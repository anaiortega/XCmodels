...
'''
G1=graphical_reports.RecordLoadCaseDisp(loadCaseName='GselfWeight',loadCaseDescr='G1: self weight',loadCaseExpr='1.0*GselfWeight',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
G2=graphical_reports.RecordLoadCaseDisp(loadCaseName='GdeadLoad',loadCaseDescr='G2: dead load',loadCaseExpr='1.0*GdeadLoad',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
QA=graphical_reports.RecordLoadCaseDisp(loadCaseName='QliveLoadA',loadCaseDescr='QA: live load A',loadCaseExpr='1.0*QliveLoadA',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
QB=graphical_reports.RecordLoadCaseDisp(loadCaseName='QliveLoadB',loadCaseDescr='QB: live load B',loadCaseExpr='1.0*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
QF=graphical_reports.RecordLoadCaseDisp(loadCaseName='QfatigueLoad',loadCaseDescr='QF: fatigue load',loadCaseExpr='1.0*QfatigueLoad',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
QAcc=graphical_reports.RecordLoadCaseDisp(loadCaseName='Qaccidental',loadCaseDescr='QAcc: accidental',loadCaseExpr='1.0*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
# ULS
ULS_A=graphical_reports.RecordLoadCaseDisp(loadCaseName='ULS_A',loadCaseDescr='ULS_A: ultimate limit state A',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadA',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
ULS_B=graphical_reports.RecordLoadCaseDisp(loadCaseName='ULS_B',loadCaseDescr='ULS_B: ultimate limit state B',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
ULS_Acc=graphical_reports.RecordLoadCaseDisp(loadCaseName='ULS_Acc',loadCaseDescr='ULS_Acc: ultimate limit state Accidental',loadCaseExpr='1.00*GselfWeight+1.00*GdeadLoad+1.00*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
#For loads display
QA_unif=graphical_reports.RecordLoadCaseDisp(loadCaseName='QliveLoadA_unif',loadCaseDescr='QA: live load A_unif',loadCaseExpr='1.0*QliveLoadA_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
...
QB_unif=graphical_reports.RecordLoadCaseDisp(loadCaseName='QliveLoadB_unif',loadCaseDescr='QB: live load B_unif',loadCaseExpr='1.0*QliveLoadB_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
...
QF_unif=graphical_reports.RecordLoadCaseDisp(loadCaseName='QfatigueLoad_unif',loadCaseDescr='QF: fatigue load_unif',loadCaseExpr='1.0*QfatigueLoad_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
...
QAcc_unif=graphical_reports.RecordLoadCaseDisp(loadCaseName='Qaccidental_unif',loadCaseDescr='QAcc: accidental_unif',loadCaseExpr='1.0*Qaccidental_unif',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[])
...
QAcc_point=graphical_reports.RecordLoadCaseDisp(loadCaseName='Qaccidental_point',loadCaseDescr='QAcc: accidental_point',loadCaseExpr='1.0*Qaccidental_point',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
