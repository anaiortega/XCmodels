...
QB=graphical_reports.LoadCaseDispParameters(loadCaseName='QliveLoadB',loadCaseDescr='QB: live load B',loadCaseExpr='1.0*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
QF=graphical_reports.LoadCaseDispParameters(loadCaseName='QfatigueLoad',loadCaseDescr='QF: fatigue load',loadCaseExpr='1.0*QfatigueLoad',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
QAcc=graphical_reports.LoadCaseDispParameters(loadCaseName='Qaccidental',loadCaseDescr='QAcc: accidental',loadCaseExpr='1.0*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
# ULS
ULS_A=graphical_reports.LoadCaseDispParameters(loadCaseName='ULS_A',loadCaseDescr='ULS_A: ultimate limit state A',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadA',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
ULS_B=graphical_reports.LoadCaseDispParameters(loadCaseName='ULS_B',loadCaseDescr='ULS_B: ultimate limit state B',loadCaseExpr='1.35*GselfWeight+1.35*GdeadLoad+1.5*QliveLoadB',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
ULS_Acc=graphical_reports.LoadCaseDispParameters(loadCaseName='ULS_Acc',loadCaseDescr='ULS_Acc: ultimate limit state Accidental',loadCaseExpr='1.00*GselfWeight+1.00*GdeadLoad+1.00*Qaccidental',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
...
QAcc_point=graphical_reports.LoadCaseDispParameters(loadCaseName='Qaccidental_point',loadCaseDescr='QAcc: accidental_point',loadCaseExpr='1.0*Qaccidental_point',setsToDispLoads=[shells],setsToDispDspRot=[shellsPcable],setsToDispIntForc=[deckCenter])
