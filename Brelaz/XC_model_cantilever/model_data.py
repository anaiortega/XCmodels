...
pt2a= points.newPoint(geom.Pos3d(0.0,cantileverWidth,0.0))
pt2b= points.newPoint(geom.Pos3d(0.0,cantileverWidth,0.0))
pt3a= points.newPoint(geom.Pos3d(0.0,2*cantileverWidth,0.0))
pt3b= points.newPoint(geom.Pos3d(0.0,2*cantileverWidth,0.0))
pt4= points.newPoint(geom.Pos3d(0.0,3*cantileverWidth,0.0))
pt5= points.newPoint(geom.Pos3d(cantileverLength,0.0,0.0))
pt6a= points.newPoint(geom.Pos3d(cantileverLength,cantileverWidth,0.0))
pt6b= points.newPoint(geom.Pos3d(cantileverLength,cantileverWidth,0.0))
pt7a= points.newPoint(geom.Pos3d(cantileverLength,2*cantileverWidth,0.0))
pt7b= points.newPoint(geom.Pos3d(cantileverLength,2*cantileverWidth,0.0))
pt8= points.newPoint(geom.Pos3d(cantileverLength,3*cantileverWidth,0.0))
