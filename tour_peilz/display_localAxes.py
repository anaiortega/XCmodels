...
displayLocalAxes(setToDisplay=shell_elements,vectorScale=0.3,viewNm="XYZPos",hCamFct=2.0,caption= shell_elements.genDescr.capitalize() + ', '+ capTexts['LocalAxes'],fileName=None)
