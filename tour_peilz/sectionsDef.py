...
slab30RCSect= def_simple_RC_section.RecordRCSlabBeamSection(name='slab30RCSect',sectionDescr="foundation slab thickness 30 cm.",concrType=concrete, reinfSteelType=reinfSteel,depth=0.3)
...
slab40RCSect= def_simple_RC_section.RecordRCSlabBeamSection(name='slab40RCSect',sectionDescr="foundation slab thickness 40 cm.",concrType=concrete, reinfSteelType=reinfSteel,depth=0.4)
...
wall30RCSect= def_simple_RC_section.RecordRCSlabBeamSection(name='wall30RCSect',sectionDescr="walls thickness 30 cm.",concrType=concrete, reinfSteelType=reinfSteel,depth=0.3)
...
wall40RCSect= def_simple_RC_section.RecordRCSlabBeamSection(name='wall40RCSect',sectionDescr="walls thickness 40 cm.",concrType=concrete, reinfSteelType=reinfSteel,depth=0.4)
...
deckRCSect= def_simple_RC_section.RecordRCSlabBeamSection(name='deckRCSect',sectionDescr="roof deck.",concrType=concrete, reinfSteelType=reinfSteel,depth=0.4)
