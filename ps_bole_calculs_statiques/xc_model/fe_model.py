...
ptA= points.newPoint(geom.Pos3d(0.0,H,0.0)) #Top of left parapet (A).
ptB= points.newPoint(geom.Pos3d(0.0,0.0,0.0)) #Bottom of left parapet (B).
ptC= points.newPoint(geom.Pos3d(W0,0.0,0.0)) #Begin of left spandrel (C).
ptD= points.newPoint(geom.Pos3d(W1,0.0,0.0)) #End of left spandrel (D).
ptE= points.newPoint(geom.Pos3d(W2,0.0,0.0)) #Begin of right spandrel (E).
ptF= points.newPoint(geom.Pos3d(W3,0.0,0.0)) #End of right spandrel (F).
ptG= points.newPoint(geom.Pos3d(W4,0.0,0.0)) #Bottom of right parapet (G).
ptH= points.newPoint(geom.Pos3d(W4,H,0.0)) #Top of right parapet (H).
...
# solProc= predefined_solutions.PlainNewtonRaphsonBandGen(deck, convergenceTestTol= 1.0e-2)
