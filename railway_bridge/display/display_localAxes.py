...
qg.displayLocalAxes(prep=prep,setToDisplay=overallSet,vectorScale=0.5,vtk_graphic_base.CameraParameters('XYZPos'),caption= capTexts['LocalAxes'],fileName=None,defFScale=0.0)
