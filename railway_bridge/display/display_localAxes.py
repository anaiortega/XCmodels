...
qg.displayLocalAxes(prep=prep,setToDisplay=overallSet,vectorScale=0.5,viewNm="XYZPos",hCamFct=1.0,caption= capTexts['LocalAxes'],fileName=None,defFScale=0.0)
