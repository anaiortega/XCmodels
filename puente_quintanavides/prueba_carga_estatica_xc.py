...
execfile('modelo/sets_prueba_carga_estatica_xci.py')
execfile('acciones/cargas_prueba_carga_estatica_xci.py')
execfile('modelo/ptos_control_prueba_carga_estatica_xci.py')
...
execfile('solucion/resuelveFASE0PCARGA_xci.py')
