...
nmbArch= "esfDiafragmaDorsal" # XXX AQUI SE ESCRIBE EL NOMBRE (SIN EXTENSIÓN) DEL LISTADO DE HIPÓTESIS
os.system("cat "+ nmbArch +".txt | sed 's/\(ELU[0-9]*\)/\"\1\"/g' > "+ nmbArch +".dat")
\extraeDatos(nmbArch+".dat")

\xLaminaConstruyeModelo("../materiales.xci","defScc1.xci","defScc2.xci")
