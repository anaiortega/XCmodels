...
'''
    ...
    # Ajustamos valores
    \numToronesNodoZona4{clear() from_string(11,12,11,10,8,8,8,8,10,11,12,11)}
    \numToronesNodoZona3{clear() from_string(11,10,10,9,7,7,7,7,9,10,10,11)}
    \numToronesNodoZona2{clear() from_string(9,9,9,8,6,7,7,6,8,9,9,9)}
    \numToronesNodoZona1{clear() from_string(8,8,7,7,6,6,6,6,7,7,8,8)}
    \numToronesNodoZona0{clear() from_string(7,7,6,6,5,5,5,5,6,6,7,7)}
