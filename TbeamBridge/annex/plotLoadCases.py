...
loadCasesGr=[]    #List of objects of type graphLoadCase.RecordLoadCaseDisp
                  #to be considered
...
G1=graphLoadCase.RecordLoadCaseDisp('GselfWeight')
...
G2=graphLoadCase.RecordLoadCaseDisp('GdeadLoad')
...
G3=graphLoadCase.RecordLoadCaseDisp('GearthPress')
...
Q1ayb=graphLoadCase.RecordLoadCaseDisp('QtrafSit1unif')
...
Q1a=graphLoadCase.RecordLoadCaseDisp('QtrafSit1a')
Q1a.unitsScale=1e-3
...
Q1b=graphLoadCase.RecordLoadCaseDisp('QtrafSit1b')
Q1b.unitsScale=1e-3
...
Q2ayb=graphLoadCase.RecordLoadCaseDisp('QtrafSit2unif')
...
Q2a=graphLoadCase.RecordLoadCaseDisp('QtrafSit2a')
Q2a.unitsScale=1e-3
...
Q2b=graphLoadCase.RecordLoadCaseDisp('QtrafSit2b')
Q2b.unitsScale=1e-3
