...
floor=gridGeom.genSurfOneXYZRegion(xyzRange=((0,0,rimHeigth),(rimSpan,floorWidth,rimHeigth)),nameSet='floor')
rim=gridGeom.genSurfOneXYZRegion(xyzRange=((0,0,0),(rimSpan,0,rimHeigth)),nameSet='rim')
#                         *** MATERIALS *** 
...
loadSet=gridGeom.getSetSurfOneRegion(ijkRange=gm.IJKRange((1,0,1),(2,1,1)), nameSet='loadSet')
