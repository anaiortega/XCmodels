...
beamLoad= xc.Vector([0.0,-pointLoad,0.0])
...
analisis= predefined_solutions.simple_static_linear(lvlHeader)
result= analisis.analyze(1)

# Checking
print('*****',lvlHeader.title,'******')
print('Uniform load: ', pointLoad/centerSpacing/1e3, ' kN/m')
...
Fv_adj= Cfire*header.material.Fv*CD*CM*Ct
Vu= Fv_adj*Av
