...
pointLoad= xc.Vector([0.0,-11.69e3,0.0]) # N/truss (see CD_reactions.ods)
for i in range(2,5):
    n= l1.getNodeI(i)
    n.newLoad(pointLoad)
...
numberOfJackStuds= bearingNecLength/(1.5*inchToMeter)
