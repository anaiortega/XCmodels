...
xcProblem.title= 'Header L= 4 feet on corridors.'
...
interiorLoad= 54.71e3 # kN/m loads at first floor (see CD_reactions.ods)
uniformLoad= xc.Vector([0.0,-interiorLoad,0.0]) 
...
## Bending
Mu= 35405.0*poundToN*footToMeter
print('Mmax= ', Mmax/1e3, ' kN Mu= ', Mu/1e3, ' kN; F= ',Mmax/Mu)

## Deflection
ratioI= sectionGeometry.Iz()/(1701*(0.0254)**4)
