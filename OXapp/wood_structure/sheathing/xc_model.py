...
# Materials
#structuralPanel= AWCNDS_materials.OSBPanels['5/8']
structuralPanel= AWCNDS_materials.OSBPanels['19/32']
#structuralPanel= AWCNDS_materials.OSBPanels['23/32']
...
y= 0.0
pt1= pointHandler.newPntFromPos3d(geom.Pos3d(0.0,y,0.0))
pt2= pointHandler.newPntFromPos3d(geom.Pos3d(span,y,0.0))
pt3= pointHandler.newPntFromPos3d(geom.Pos3d(2.0*span,y,0.0))
pt4= pointHandler.newPntFromPos3d(geom.Pos3d(3.0*span,y,0.0))
# y+= thickness
# pt11= pointHandler.newPntFromPos3d(geom.Pos3d(0.0,y,0.0))
# pt12= pointHandler.newPntFromPos3d(geom.Pos3d(span,y,0.0))
# pt13= pointHandler.newPntFromPos3d(geom.Pos3d(2.0*span,y,0.0))
# pt14= pointHandler.newPntFromPos3d(geom.Pos3d(3.0*span,y,0.0))
y+= thickness
pt21= pointHandler.newPntFromPos3d(geom.Pos3d(0.0,y,0.0))
pt22= pointHandler.newPntFromPos3d(geom.Pos3d(span,y,0.0))
pt23= pointHandler.newPntFromPos3d(geom.Pos3d(2.0*span,y,0.0))
pt24= pointHandler.newPntFromPos3d(geom.Pos3d(3.0*span,y,0.0))
