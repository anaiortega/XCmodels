...
uniformLoad= uniformLoadW #uniformLoadMax
...
columnPos= geom.Pos3d(span/2.0,0.0,0.0) #Conservative
nColumnPos= xcTotalSet.getNearestNode(columnPos)
nColumnPos.newLoad(xc.Vector([0.0,-60e3,0.0]))
