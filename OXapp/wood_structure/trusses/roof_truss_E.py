...
depth= 22*inchToMeter-lowerChordSectionGeometry.h
...
## Truss E
lowerChordAxisE= geom.Segment3d(geom.Pos3d(0.0,0.0,0.0),geom.Pos3d(9.4707,0.0,0.0))
upperChordAxisE= geom.Segment3d(geom.Pos3d(0.0,0.0,0.5598),geom.Pos3d(9.4707,0.0,0.7547))
...
joist_B= points.newPntFromPos3d(geom.Pos3d(11.3564,0.0,0.7935))
...
## Dead load.
roofDeadLoad= xc.Vector([0.0,0.0,-0.86e3*centerSpacingTrusses])
...
## Live load.
roofLiveLoad= xc.Vector([0.0,0.0,-0.96e3*centerSpacingTrusses])
...
## Snow load.
roofSnowLoad= xc.Vector([0.0,0.0,-2.01e3*centerSpacingTrusses])
...
## Wind load.
roofWindLoad= xc.Vector([0.0,0.0,1.27e3*centerSpacingTrusses])
...
def reportResults(combName):
    writeResults(combName,' roof', [trussE])
