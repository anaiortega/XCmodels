...
studSpacing= 19.2*inchToMeter # studs doubled!!!
...
stud= AWCNDS_materials.Member(0.3,studHeight, lumber2x8Geom)
...
Vwind= windStudPressure*studHeight/2.0

## Gravity loads
wallGLoad= 30.52e3 # N/m facade Zone AB at second floor
...
print('maximum shear due to wind:', Vwind/1e3, ' kN', Vwind/1e3*kNToPound, ' lb')
