...
Fb= 675*psiToPa
Fv= 135*psiToPa # Shear parallel to grain
Fc= 725*psiToPa
Fc_perp= 425*psiToPa #Perpendicular to grain
Cr= 1.0
CF= 1.3
...
## Loaded nodes.
loadedNodes= list()
pos= pt11.getPos #Position of the first loaded node
xLast= pt15.getPos.x
while pos.x<xLast:
