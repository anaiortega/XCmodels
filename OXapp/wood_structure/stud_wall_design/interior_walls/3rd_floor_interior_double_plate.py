...
inchToMeter= 0.0254
title= '3rd floor interior double plate.'
...
deadLoad= 3.08e3 # kN/truss
liveLoad= liveLoadReductionFactor*3.76e3 # kN/truss
snowLoad= 7.88e3 # kN/truss
windLoad= -4.98e3 # kN/truss

doublePlate= plates_model.DoublePlate(title, plateSection, studSpacing, trussSpacing, pointLoadFactor= 0.75);
