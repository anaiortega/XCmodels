...
title= '2nd floor AB interior stud.'
# Actions
## Reduction in uniform live loads.
AT= 2*10.0*10.0 # Tributary area
...
deadLoad= xc.Vector([0.0,19.61e3]) # kN/m
liveLoad= liveLoadReductionFactor*xc.Vector([0.0,31.66e3]) # kN/m
