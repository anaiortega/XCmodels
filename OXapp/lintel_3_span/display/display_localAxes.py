...
setToDisp=beam+column
qg.display_local_axes(prep=prep,setToDisplay=setToDisp,vectorScale=0.15,viewDef= vtk_graphic_base.CameraParameters('XYZPos',2.0),caption= 'LocalAxes',fileName=None,defFScale=0.0)
