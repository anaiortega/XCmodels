...
print('frontFillDepth= ', frontFillDepth,' m')
...
zGroundBackFill= wallHead-6*FEET_2_METER #Back fill
...
zGroundFrontFill= wallHead-wall.stemHeight+frontFillDepth #Front fill
