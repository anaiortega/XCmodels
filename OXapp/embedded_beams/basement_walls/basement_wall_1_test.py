...
wallHead= -(1.0*FEET_2_METER+4.0*INCH_2_METER)
...
trafficEarthPressure= earth_pressure.StripLoadOnBackfill(qLoad= 11.97e3,zLoad= 0.0, distWall= 3.0, stripWidth= 2)
...
wall.modelSpace.addNewLoadCaseToDomain('prueba','1.0*selfWeight+1.0*deadLoad+1.0*trafficLoad')
oh.displayLoads()
wall.resultComb('prueba')
oh.displayReactions()
