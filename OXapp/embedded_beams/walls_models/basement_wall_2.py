...
wallHead= -(2.0*FEET_2_METER+8.0*INCH_2_METER)
...
wall.stemReinforcement.setReinforcement(5,A16_40.getCopy(ACI_limit_state_checking.RebarController('B')))
