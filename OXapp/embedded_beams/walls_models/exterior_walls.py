...
wallHead= -2.0*FEET_2_METER-10.0*INCH_2_METER
topOfFoundation= -9.0*FEET_2_METER-10.0*INCH_2_METER
...
wall.stemReinforcement.setReinforcement(1,A13_15.getCopy(ACI_limit_state_checking.RebarController('B')))
...
wall.stemReinforcement.setReinforcement(11,A10_15.getCopy(ACI_limit_state_checking.RebarController('B')))
...
## Dead load from ramp.
buildingDeadLoad= 11.0/4.0*FEET_2_METER*0.3*2500*9.81
