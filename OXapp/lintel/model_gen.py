...
beam=gridGeom.genLinOneXYZRegion(xyzRange=((0,0,zBeam),(0,yBeamEnd,zBeam)),nameSet='beam')
column=gridGeom.genLinOneXYZRegion(xyzRange=((0,yBeamEnd,0),(0,yBeamEnd,zColumn)),nameSet='column')
#                         *** MATERIALS *** 
...
geomSectBeam=sectpr.RectangularSection(name='geomSectBeam',b=wColumn,h=hBeam)
...
fem.multi_mesh(preprocessor=prep,lstMeshSets=[beamConcr_mesh,columnConcr_mesh])
...
#Loads
grav=9.81
selfWeight=loads.InertialLoad(name='selfWeight', lstMeshSets=[beamConcr_mesh,columnConcr_mesh], vAccel=xc.Vector( [0.0,0.0,-grav]))
