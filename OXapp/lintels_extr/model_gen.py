...
beamCent=gridGeom.genLinOneXYZRegion(xyzRange=((0,0,zBeam),(0,yBeamCent,zBeam)),nameSet='beamCent')
beamExtr=gridGeom.genLinOneXYZRegion(xyzRange=((0,yBeamCent,zBeam),(0,yBeamEnd,zBeam)),nameSet='beamExtr')
