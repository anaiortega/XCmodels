...
beamXsteel_mat= ASTMmat.WShape(steel=strSteel,name='W14X43')
beamXsteel_mat.defElasticShearSection3d(preprocessor,strSteel)
WbeamYsteel_mat= ASTMmat.WShape(steel=strSteel,name='W14X53')
...
EbeamYsteel_mat= ASTMmat.WShape(steel=strSteel,name='W14X53')
