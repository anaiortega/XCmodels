...
wall.stemReinforcement.setReinforcement(1,A16_30.getCopy(ACI_limit_state_checking.RebarController('B')))
...
buildingDeadLoad= buildingLoadFactor*79.46e3 # Ramp cover + second floor trusses + first floor planks
...
buildingLiveLoad= buildingLoadFactor*38.42e3 # Ramp cover + second floor trusses + first floor planks
...
buildingSnowLoad= buildingLoadFactor*13.30e3 
...
buildingWindLoad= buildingLoadFactor*-8.96e3 
