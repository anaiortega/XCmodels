...
for lc in loadCasesToDisplay:
    ...
    for st in lc.setsToDispIntForc:
        for arg in lc.listIntForc:
            ...
            lcs.displayIntForc(itemToDisp=arg,setToDisplay=st,fConvUnits= fcUn,unitDescription=unDesc,viewName=lc.viewName,hCamFct=lc.hCamFct,fileName=fname,defFScale=1)
