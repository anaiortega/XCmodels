...
for lc in loadCasesToDisplay:
        qg.displayLoad(preprocessor=prep,setToDisplay=overallSet,loadCaseNm=lc.name,unitsScale=1e-3,vectorScale=0.05, multByElemArea=False,viewNm='XYZPos',hCamFct=1,caption='',fileName=None,defFScale=1.0)
