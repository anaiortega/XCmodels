...
setToDisplay=otro
qg.displayLocalAxes(prep=prep,setToDisplay=setToDisplay,vectorScale=0.15,viewNm="ZPos",hCamFct=2.0,caption= capTexts['LocalAxes'],fileName=None,defFScale=0.0)
#qg.displayLocalAxes(prep=prep,setToDisplay=columnZ,vectorScale=0.15,viewNm="XYZPos",hCamFct=1.0,caption=capTexts['LocalAxes'],fileName=None,defFScale=0.0)
