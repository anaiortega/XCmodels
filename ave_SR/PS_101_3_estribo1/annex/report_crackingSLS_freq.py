...
pathGrph='res_PS101_estribo1/graphics/crackingSLS_freq/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
texReportFile='res_PS101_estribo1/report_crackingSLS_freq.tex'  #laTex file where to include the graphics 
