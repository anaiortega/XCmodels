...
report_graphics_outDir='res_PS101_estribo1/graphics/sections/'

reportDir='./res_PS101_estribo1'     #directory where sections report will be placed


reportFileName='res_PS101_estribo1/sectReport.tex'
