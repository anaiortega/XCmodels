...
pathGrph='res_PS101_estribo1/graphics/loads/'   #directory to place the figures
                                  #(do not use ./text/....)'
texReportFile='res_PS101_estribo1/report_loads.tex'  #laTex file where to include the graphics 
