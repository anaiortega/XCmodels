...
zap_rg=[gut.def_rg_cooLim(XYZLists,Xmurestr,Yzap,(0,0))]

murestrZ1_rg=[gut.def_rg_cooLim(XYZLists,Xmurestr,Ymurestr,zZ1)]
murestrZ2_rg=[gut.def_rg_cooLim(XYZLists,Xmurestr,Ymurestr,zZ2mur)]

aletiZ1_rg=[gut.def_rg_cooLim(XYZLists,Xaleti,Yalet,zZ1)]
aletiZ2_rg=[gut.def_rg_cooLim(XYZLists,Xaleti,Yalet,zZ2alet)]
aletiZ3_rg=[gut.def_rg_cooLim(XYZLists,Xaleti,Yalet,zZ3alet)]

aletdZ1_rg=[gut.def_rg_cooLim(XYZLists,Xaletd,Yalet,zZ1)]
aletdZ2_rg=[gut.def_rg_cooLim(XYZLists,Xaletd,Yalet,zZ2alet)]
aletdZ3_rg=[gut.def_rg_cooLim(XYZLists,Xaletd,Yalet,zZ3alet)]

if Lvoladzi >0:
    voladzi_rg=[gut.def_rg_cooLim(XYZLists,Xaleti,(yZap,yVoladz),zZ3alet)]
...
zap_mesh=fem.SurfSetToMesh(surfSet=zap,matSect=zap_mat,elemSize=eSize,elemType='ShellMITC4')

murestrZ1_mesh=fem.SurfSetToMesh(surfSet=murestrZ1,matSect=murestr_mat,elemSize=eSize,elemType='ShellMITC4')
murestrZ2_mesh=fem.SurfSetToMesh(surfSet=murestrZ2,matSect=murestr_mat,elemSize=eSize,elemType='ShellMITC4')

aletiZ1_mesh=fem.SurfSetToMesh(surfSet=aletiZ1,matSect=aletiZ1_mat,elemSize=eSize,elemType='ShellMITC4')
aletiZ2_mesh=fem.SurfSetToMesh(surfSet=aletiZ2,matSect=aletiZ2_mat,elemSize=eSize,elemType='ShellMITC4')
aletiZ3_mesh=fem.SurfSetToMesh(surfSet=aletiZ3,matSect=aletiZ3_mat,elemSize=eSize,elemType='ShellMITC4')

aletdZ1_mesh=fem.SurfSetToMesh(surfSet=aletdZ1,matSect=aletdZ1_mat,elemSize=eSize,elemType='ShellMITC4')
aletdZ2_mesh=fem.SurfSetToMesh(surfSet=aletdZ2,matSect=aletdZ2_mat,elemSize=eSize,elemType='ShellMITC4')
aletdZ3_mesh=fem.SurfSetToMesh(surfSet=aletdZ3,matSect=aletdZ3_mat,elemSize=eSize,elemType='ShellMITC4')

if Lvoladzi >0:
    voladzi_mesh=fem.SurfSetToMesh(surfSet=voladzi,matSect=aletiZ3_mat,elemSize=eSize,elemType='ShellMITC4')
if Lvoladzd >0:
    voladzd_mesh=fem.SurfSetToMesh(surfSet=voladzd,matSect=aletdZ3_mat,elemSize=eSize,elemType='ShellMITC4')
...
ptsAp=[gridGeom.getPntGrid((xList.index(x),yList.index(yMurEstr),zList.index(zMur))) for x in xCoordNeopr]
