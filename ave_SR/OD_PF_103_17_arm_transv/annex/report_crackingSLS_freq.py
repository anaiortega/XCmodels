...
pathGrph='res_OD_PF_103_17/graphics/crackingSLS_freq/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
texReportFile='res_OD_PF_103_17/report_crackingSLS_freq.tex'  #laTex file where to include the graphics 
