...
report_graphics_outDir='res_OD_PF_103_17/graphics/sections/'

reportDir='./res_OD_PF_103_17'     #directory where sections report will be placed


reportFileName='res_OD_PF_103_17/sectReport.tex'
