...
qg.display_local_axes(prep=prep,setToDisplay=setToDisplay,vectorScale=0.15,viewDef= vtk_graphic_base.CameraParameters('YPos',2.0),caption= cfg.capTexts['LocalAxes'],fileName=None,defFScale=0.0)
