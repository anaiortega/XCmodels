...
dintExtRCSects= defSimpleRCSection.RecordRCSlabBeamSection(name='dintExtRCSects',sectionDescr='dintel, zona extremos',concrType=concrete, reinfSteelType=reinfSteel,depth=deckTh)  
...
dintCentRCSects= defSimpleRCSection.RecordRCSlabBeamSection(name='dintCentRCSects',sectionDescr='dintel, zona central',concrType=concrete,reinfSteelType=reinfSteel,depth=deckTh)  
...
losCimExtRCSects= defSimpleRCSection.RecordRCSlabBeamSection(name='losCimExtRCSects',sectionDescr='losa de cimentación, zona exterior',concrType=concrete, reinfSteelType=reinfSteel,depth=baseSlabTh)
...
losCimCentRCSects= defSimpleRCSection.RecordRCSlabBeamSection(name='losCimCentRCSects',sectionDescr='losa de cimentación, zona central',concrType=concrete, reinfSteelType=reinfSteel,depth=baseSlabTh)
...
hastIzqRCSects= defSimpleRCSection.RecordRCSlabBeamSection(name='hastIzqRCSects',sectionDescr='hastial izquierdo',concrType=concrete, reinfSteelType=reinfSteel,depth=wallTh)
#0:Vert
#1:Hor
#+:Cent
...
hastDerRCSects= defSimpleRCSection.RecordRCSlabBeamSection(name='hastDerRCSects',sectionDescr='hastial izquierdo',concrType=concrete, reinfSteelType=reinfSteel,depth=wallTh)
#0:Vert
#1:Hor
#+:Int
