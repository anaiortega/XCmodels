...
'''
G1=graphical_reports.RecordLoadCaseDisp(loadCaseName='G1',loadCaseDescr='G1: Peso propio',loadCaseExpr='1.0*G1',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
G2a=graphical_reports.RecordLoadCaseDisp(loadCaseName='G2a',loadCaseDescr='G2a: Carga muerta en servicio',loadCaseExpr='1.0*G2a',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
G2a.unitsScaleLoads=1e-3
G2a.vectorScaleLoads=0.07
...
G2b=graphical_reports.RecordLoadCaseDisp(loadCaseName='G2b',loadCaseDescr='G2b: Carga muerta desbalastado 1',loadCaseExpr='1.0*G2b',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
G2b.unitsScaleLoads=1e-3
G2b.vectorScaleLoads=0.07
...
G2c=graphical_reports.RecordLoadCaseDisp(loadCaseName='G2c',loadCaseDescr='G2c: Carga muerta desbalastado 2',loadCaseExpr='1.0*G2c',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
G2c.unitsScaleLoads=1.0e-3
G2c.vectorScaleLoads=0.07
...
G3=graphical_reports.RecordLoadCaseDisp(loadCaseName='G3',loadCaseDescr='G3: Empuje del terreno',loadCaseExpr='1.0*G3',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
Q1a=graphical_reports.RecordLoadCaseDisp(loadCaseName='Q1a',loadCaseDescr='Q1a: Tren de cargas posición 1',loadCaseExpr='1.0*Q1a',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
Q1a_1via=graphical_reports.RecordLoadCaseDisp(loadCaseName='Q1a_1via',loadCaseDescr='Q1a_1via: Tren de cargas posición 1 en sit. desbalastado',loadCaseExpr='1.0*Q1a_1via',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
Q1b=graphical_reports.RecordLoadCaseDisp(loadCaseName='Q1b',loadCaseDescr='Q1b: Tren de cargas posición 2',loadCaseExpr='1.0*Q1b',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
Q1c=graphical_reports.RecordLoadCaseDisp(loadCaseName='Q1c',loadCaseDescr='Q1c: Tren de cargas posición 3',loadCaseExpr='1.0*Q1c',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
Q2b=graphical_reports.RecordLoadCaseDisp(loadCaseName='Q2b',loadCaseDescr='Q2b: SC paso fauna y nivel agua',loadCaseExpr='1.0*Q2b',setsToDispLoads=[loscPlusHasti],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
A1a=graphical_reports.RecordLoadCaseDisp(loadCaseName='A1a',loadCaseDescr='A1a: Descarrilamiento situación 1',loadCaseExpr='1.0*A1a',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
...
A1b=graphical_reports.RecordLoadCaseDisp(loadCaseName='A1b',loadCaseDescr='A1b: Descarrilamiento situación 2',loadCaseExpr='1.0*A1b',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
A1b.unitsScaleLoads=1.0e-3
A1b.vectorScaleLoads=0.07
...
C1=graphical_reports.RecordLoadCaseDisp(loadCaseName='C1',loadCaseDescr='C1: Empuje del terreno (construcción)',loadCaseExpr='1.0*C1',setsToDispLoads=[marco],setsToDispDspRot=[marco],setsToDispIntForc=[losas,hastIzq])
