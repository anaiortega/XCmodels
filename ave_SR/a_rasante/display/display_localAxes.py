...
setToDisplay=dintel
qg.displayLocalAxes(prep=prep,setToDisplay=setToDisplay,vectorScale=0.15,viewNm="XYZPos",hCamFct=2.0,caption= cfg.capTexts['LocalAxes'],fileName=None,defFScale=0.0)
