...
pathGrph='res_a_rasante/graphics/normStrsULS/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
argsBmElScale=[]
texReportFile='res_a_rasante/report_normStrsULS.tex'  #laTex file where to include the graphics 
