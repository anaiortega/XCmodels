...
pathGrph='res_a_rasante/graphics/shearULS/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
setsShEl=[losasCortante,hastIzq]
...
texReportFile='res_a_rasante/report_shearULS.tex'  #laTex file where to include the graphics 
