...
pathGrph='res_a_rasante/graphics/loads/'   #directory to place the figures
                                  #(do not use ./text/....)'
texReportFile='res_a_rasante/report_loads.tex'  #laTex file where to include the graphics 
