...
pathGrph='res_a_rasante/graphics/crackingSLS_freq/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
texReportFile='res_a_rasante/report_crackingSLS_freq.tex'  #laTex file where to include the graphics 
