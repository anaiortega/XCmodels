...
report_graphics_outDir='res_a_rasante/graphics/sections/'

reportDir='./res_a_rasante'     #directory where sections report will be placed


reportFileName='res_a_rasante/sectReport.tex'
