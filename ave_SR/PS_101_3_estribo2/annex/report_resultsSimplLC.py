...
pathGrph='res_PS101_estribo2/graphics/resSimplLC/'   #directory to place the figures
                                        #(do not use ./text/....)'
texReportFile='res_PS101_estribo2/report_resSimplLC.tex'  #laTex file where to include the graphics
