...
pathGrph='res_PS101_estribo2/graphics/shearULS/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
texReportFile='res_PS101_estribo2/report_shearULS.tex'  #laTex file where to include the graphics 
