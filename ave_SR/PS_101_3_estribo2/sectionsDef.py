...
voladziRCSects= element_section_map.RCSlabBeamSection(name='voladziRCSects',sectionDescr='aleta izquierda, voladizo',concrType=concrete, reinfSteelType=reinfSteel,depth=espAletiZ3,elemSet=voladzi)
#D1: horizontal rebars
#D2: vertical rebars
#positiv: trasdós
#negativ: intradós
