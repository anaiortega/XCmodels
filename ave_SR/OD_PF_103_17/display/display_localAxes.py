...
qg.displayLocalAxes(prep=prep,setToDisplay=dintel,vectorScale=0.15,viewDef= vtk_graphic_base.CameraParameters('ZPos',2.0),caption= cfg.capTexts['LocalAxes'],fileName=None,defFScale=0.0)
