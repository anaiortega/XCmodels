...
def rg_mur(Ycoor,Zcoor=ZmurAlig,Xmur=[-xAlig2,-xAlig1,0,xAlig1,xAlig2],xyzL=XYZLists):
    rg=list()
    for x in Xmur:
...
xmurRiostr=[-xArranqVoladz,-xAlig2,-xAlig1,0,xAlig1,xAlig2,xArranqVoladz]
...
riostrP_mat=tm.DeckMaterialData(name='riostrP_mat',thickness= espPuntMaz,material=concrData)
riostrP_mat.setupElasticSection(preprocessor=prep)
...
riostrEstr1_mesh=fem.LinSetToMesh(linSet=riostrEstr1,matSect=riostrEstr_mat,elemSize=eSize,vDirLAxZ=xc.Vector([0,0,1]),elemType='ElasticBeam3d',dimElemSpace=3,coordTransfType='linear')
riostrEstr2_mesh=fem.LinSetToMesh(linSet=riostrEstr2,matSect=riostrEstr_mat,elemSize=eSize,vDirLAxZ=xc.Vector([0,0,1]),elemType='ElasticBeam3d',dimElemSpace=3,coordTransfType='linear')
...
murRP1_mesh=fem.SurfSetToMesh(surfSet=murRP1,matSect=riostrP_mat,elemSize=eSize,elemType='ShellMITC4')
murRP2_mesh=fem.SurfSetToMesh(surfSet=murRP2,matSect=riostrP_mat,elemSize=eSize,elemType='ShellMITC4')
...
supTablero.description='Superficie tablero'
losas=losSup+voladzCent+voladzExtr+losInf
murosAlig=murAlig+murExtAlig
tablero=losInf+losSup+murAlig+murExtAlig+riostrP
...
tablCentr=murAlig+murExtAlig+riostrP
...
TunifContr_02=loads.StrainLoadOnShells(name='TunifContr_02', xcSet=murosAlig,DOFstrain=0,strain=coefDilat*Tunif_contr)
TunifDilat_01=loads.StrainLoadOnShells(name='TunifDilat_01', xcSet=losas,DOFstrain=1,strain=coefDilat*Tunif_dilat)
TunifDilat_02=loads.StrainLoadOnShells(name='TunifDilat_02', xcSet=murosAlig,DOFstrain=0,strain=coefDilat*Tunif_dilat)
GradTcal1=loads.StrainLoadOnShells(name='GradTcal1', xcSet=supTablero,DOFstrain=1,strain=coefDilat*Tfibrsup_cal)
GradTcal2=loads.StrainLoadOnShells(name='GradTcal2', xcSet=tablCentr,DOFstrain=0,strain=coefDilat*Tfibrsup_cal/2.0)
GradTfrio1=loads.StrainLoadOnShells(name='GradTfrio1', xcSet=supTablero,DOFstrain=1,strain=coefDilat*Tfibrsup_fria)
GradTfrio2=loads.StrainLoadOnShells(name='GradTfrio2', xcSet=tablCentr,DOFstrain=0,strain=coefDilat*Tfibrsup_fria/2.0)

Retracc_01=loads.StrainLoadOnShells(name='Retracc_01', xcSet=losas,DOFstrain=1,strain=eps_retracc)
Retracc_02=loads.StrainLoadOnShells(name='Retracc_02', xcSet=murosAlig,DOFstrain=0,strain=eps_retracc)
...
TunifContr_02_neopr=loads.StrainLoadOnShells(name='TunifContr_02_neopr', xcSet=murosAlig,DOFstrain=0,strain=coefDilat*Tunif_contr_neopr)
...
TunifDilat_02_neopr=loads.StrainLoadOnShells(name='TunifDilat_02_neopr', xcSet=murosAlig,DOFstrain=0,strain=coefDilat*Tunif_dilat_neopr)
...
Q1c_vext_v1=lmb.VehicleDistrLoad(name='Q1c_vext_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane1, xCentr=xCent_vext,yCentr=yCent_van1,hDistr=hDistrQ,slopeDistr=1.0)
Q1c_vext_v2=lmb.VehicleDistrLoad(name='Q1c_vext_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane1, xCentr=xCent_vext,yCentr=yCent_van2,hDistr=hDistrQ,slopeDistr=1.0)
Q2c_vcent_v1=lmb.VehicleDistrLoad(name='Q2c_vcent_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane2, xCentr=xCent_vcent,yCentr=yCent_van1,hDistr=hDistrQ,slopeDistr=1.0)
Q2c_vcent_v2=lmb.VehicleDistrLoad(name='Q2c_vcent_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane2, xCentr=xCent_vcent,yCentr=yCent_van2,hDistr=hDistrQ,slopeDistr=1.0)
Q3c_vint_v1=lmb.VehicleDistrLoad(name='Q3c_vint_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane3, xCentr=xCent_vint,yCentr=yCent_van1,hDistr=hDistrQ,slopeDistr=1.0)
Q3c_vint_v2=lmb.VehicleDistrLoad(name='Q3c_intt_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane3, xCentr=xCent_vint,yCentr=yCent_van2,hDistr=hDistrQ,slopeDistr=1.0)
Q1c_vcent_v2=lmb.VehicleDistrLoad(name='Q1c_vcent_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane1, xCentr=xCent_vcent,yCentr=yCent_van2,hDistr=hDistrQ,slopeDistr=1.0)
Q2c_vint_v2=lmb.VehicleDistrLoad(name='Q2c_vint_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane2, xCentr=xCent_vint,yCentr=yCent_van2,hDistr=hDistrQ,slopeDistr=1.0)
Q3c_vext_v2=lmb.VehicleDistrLoad(name='Q3c_vext_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane3, xCentr=xCent_vext,yCentr=yCent_van2,hDistr=hDistrQ,slopeDistr=1.0)

Q1e_vcent_v2=lmb.VehicleDistrLoad(name='Q1e_vcent_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane1, xCentr=xCent_vcent,yCentr=yExtr_van2,hDistr=hDistrQ,slopeDistr=1.0)
Q2e_vint_v2=lmb.VehicleDistrLoad(name='Q2e_vint_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane2, xCentr=xCent_vint,yCentr=yExtr_van2,hDistr=hDistrQ,slopeDistr=1.0)
Q3e_vext_v2=lmb.VehicleDistrLoad(name='Q3e_vext_v2',xcSet=supTablero,loadModel=slm.IAP_notional_lane3, xCentr=xCent_vext,yCentr=yExtr_van2,hDistr=hDistrQ,slopeDistr=1.0)

Q1e_vcent_v1=lmb.VehicleDistrLoad(name='Q1e_vcent_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane1, xCentr=xCent_vcent,yCentr=yExtr_van1,hDistr=hDistrQ,slopeDistr=1.0)
Q2e_vint_v1=lmb.VehicleDistrLoad(name='Q2e_vint_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane2, xCentr=xCent_vint,yCentr=yExtr_van1,hDistr=hDistrQ,slopeDistr=1.0)
Q3e_vext_v1=lmb.VehicleDistrLoad(name='Q3e_vext_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane3, xCentr=xCent_vext,yCentr=yExtr_van1,hDistr=hDistrQ,slopeDistr=1.0)

Q1c_vcent_v1=lmb.VehicleDistrLoad(name='Q1c_vcent_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane1, xCentr=xCent_vcent,yCentr=yCent_van1,hDistr=hDistrQ,slopeDistr=1.0)
Q2c_vint_v1=lmb.VehicleDistrLoad(name='Q2c_vint_v1',xcSet=supTablero,loadModel=slm.IAP_notional_lane2, xCentr=xCent_vint,yCentr=yCent_van1,hDistr=hDistrQ,slopeDistr=1.0)
...
pilasInf.color=colors.setColor['brown04']
pilasSup.description='Pilas, zona superior'
pilasSup.color=colors.setColor['brown01']
pilas.description='Pilas'
pilas.color=colors.setColor['brown03']
losInf.description='Losa aligerada, cordón inferior'
losInf.color=colors.setColor['purple03']
losSup.description='Losa aligerada, cordón superior'
losSup.color=colors.setColor['purple01']
murAlig.description='Losa aligerada, almas'
murAlig.color=colors.setColor['orange02']
murExtAlig.description='Losa aligerada, almas borde'
murExtAlig.color=colors.setColor['yellow02']
voladzCent.description='Voladizo, zona central'
voladzCent.color=colors.setColor['brown01']
voladzExtr.description='Voladizo, zona de borde'
voladzExtr.color=colors.setColor['brown02']
supTablero.description='Superficie tablero'
supTablero.color=colors.setColor['yellow02']
total=prep.getSets.getSet('total')

overallSet=
