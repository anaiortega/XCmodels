...
sh4=defSimpleRCSection.RecordShearReinforcement(familyName= "sh4",nShReinfBranches= 5.0,areaShReinfBranch= areaFi8,shReinfSpacing= 0.20,angAlphaShReinf= math.radians(90),angThetaConcrStruts= math.radians(30))
...
sh1=defSimpleRCSection.RecordShearReinforcement(familyName= "sh1",nShReinfBranches= 5.0,areaShReinfBranch= areaFi10,shReinfSpacing= 0.20,angAlphaShReinf= math.radians(90),angThetaConcrStruts= math.radians(30))
