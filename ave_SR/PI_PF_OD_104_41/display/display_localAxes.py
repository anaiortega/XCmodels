...
qg.displayLocalAxes(prep=prep,setToDisplay=hastiales,vectorScale=0.15,viewNm="XYZPos",hCamFct=2.0,caption= cfg.capTexts['LocalAxes'],fileName=None,defFScale=0.0)
