...
qg.displayLocalAxes(prep=prep,setToDisplay=hastiales,vectorScale=0.15,viewDef= vtk_graphic_base.CameraParameters('XYZPos',2.0),caption= cfg.capTexts['LocalAxes'],fileName=None,defFScale=0.0)
