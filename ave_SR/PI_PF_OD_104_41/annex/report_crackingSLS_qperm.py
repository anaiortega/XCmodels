...
pathGrph='res_PI_PF_OD_104_41/graphics/crackingSLS_qperm/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
texReportFile='res_PI_PF_OD_104_41/report_crackingSLS_qperm.tex'  #laTex file where to include the graphics 
