...
report_graphics_outDir='res_PI_PF_OD_104_41/graphics/sections/'

reportDir='./res_PI_PF_OD_104_41'     #directory where sections report will be placed


reportFileName='res_PI_PF_OD_104_41/sectReport.tex'
