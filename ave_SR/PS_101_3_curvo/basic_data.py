...
Qfrenado=490e3 #carga total de frenado a aplicar en via fictícea 1 [N]

Qderrape=0.25*Qfrenado #carga total de derrape a aplicar en via fictícea 1 [N]
                       #simultánea a frenado

QCentrif=80e3  #fuerza centrífuga total [N]
#  viento
...
zInfPilAer=-hTotPilas+3  #aprox. 2 m enterrado
...
qPPlos=pespConcr*ALos/(anchLosaAlig+2*ladoCartab) #[N/m2]
...
xViaFict3=-xArranqVoladz #en este caso coinciden
#xList=[-xBordeVoladz,-xMedVoladz,-xBordeCalz,-xArranqVoladz,xViaFict3,-xAlig3,-xAlig2,-xPila,-xAlig1,xViaFict2,0,xAlig1,xPila,xAlig2,xAlig3,xArranqVoladz,xBordeCalz,xMedVoladz,xBordeVoladz]
xList=[-xBordeVoladz,-xMedVoladz,-xBordeCalz,-xArranqVoladz,-xAlig3,-xAlig2,-xPila,-xAlig1,xViaFict2,0,xAlig1,xPila,xAlig2,xAlig3,xArranqVoladz,xBordeCalz,xMedVoladz,xBordeVoladz]
