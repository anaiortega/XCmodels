...
pathGrph='res_PS101_curvo/graphics/shearULS/'   #directory to place the figures
                                        #(do not use ./text/....)'
...
texReportFile='res_PS101_curvo/report_shearULS.tex'  #laTex file where to include the graphics 
