...
pathGrph='res_PS101_curvo/graphics/loads/'   #directory to place the figures
                                  #(do not use ./text/....)'
texReportFile='res_PS101_curvo/report_loads.tex'  #laTex file where to include the graphics 
