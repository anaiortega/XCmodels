...
report_graphics_outDir='res_PS101_curvo/graphics/sections/'

reportDir='./res_PS101_curvo'     #directory where sections report will be placed


reportFileName='res_PS101_curvo/sectReport.tex'
