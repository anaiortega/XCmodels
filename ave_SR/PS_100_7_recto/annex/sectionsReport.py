...
report_graphics_outDir='res_PS100_recto/graphics/sections/'

reportDir='./res_PS100_recto'     #directory where sections report will be placed


reportFileName='res_PS100_recto/sectReport.tex'
