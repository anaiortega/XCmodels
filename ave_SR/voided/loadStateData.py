...
Q31neopr=graphical_reports.LoadCaseDispParameters(loadCaseName='Q31neopr',loadCaseDescr='Q31neopr: Temperatura uniforme, contracción',loadCaseExpr='1.0*Q31neopr',setsToDispLoads=[overallSet],setsToDispDspRot=[overallSet],setsToDispIntForc=[])
Q32neopr=graphical_reports.LoadCaseDispParameters(loadCaseName='Q32neopr',loadCaseDescr='Q32neopr: Temperatura uniforme, dilatación',loadCaseExpr='1.0*Q32neopr',setsToDispLoads=[],setsToDispDspRot=[overallSet],setsToDispIntForc=[])
#Thermal load cases (gradient)
Q33=graphical_reports.LoadCaseDispParameters(loadCaseName='Q33',loadCaseDescr='Q33: Diferencia temperatura, fibra sup. más caliente',loadCaseExpr='1.0*Q33',setsToDispLoads=[],setsToDispDspRot=[overallSet],setsToDispIntForc=[])
Q34=graphical_reports.LoadCaseDispParameters(loadCaseName='Q34',loadCaseDescr='Q34: Diferencia temperatura, fibra sup. más fría',loadCaseExpr='1.0*Q34',setsToDispLoads=[],setsToDispDspRot=[overallSet],setsToDispIntForc=[])
'''
LSD=[G1,G2,G3,Q1a1,Q1a2,Q1b1,Q1b2,Q1c,Q1d,Q1e,Q1bFren,Q1dFren,Q1eFren,Q21,Q22]

if abutment.lower()[0]=='y':
    G4=graphical_reports.LoadCaseDispParameters(loadCaseName='G4',loadCaseDescr='G4: empuje del relleno sobre estribo',loadCaseExpr='1.0*G4',setsToDispLoads=[overallSet],setsToDispDspRot=[overallSet],setsToDispIntForc=[])
    Q4=graphical_reports.LoadCaseDispParameters(loadCaseName='Q4',loadCaseDescr='Q4: sobrecarga sobre relleno trasdós estribo',loadCaseExpr='1.0*Q4',setsToDispLoads=[overallSet],setsToDispDspRot=[overallSet],setsToDispIntForc=[])
    LSD.insert(3,G4)
    LSD.append(Q4)
...
resLoadCases=[G1,G2,G3,Q1a1,Q1a2,Q1b1,Q1b2,Q1c,Q1d,Q1e,Q1bFren,Q1dFren,Q1eFren,Q21,Q22]
resLoadCases_neopr=[G1,G2,G3,Q1a1,Q1a2,Q1b1,Q1b2,Q1c,Q1d,Q1e,Q1bFren,Q1dFren,Q1eFren,Q21,Q22]
