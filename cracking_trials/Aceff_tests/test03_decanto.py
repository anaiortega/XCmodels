...
F=[25e6*1.5/10,0,0,0,0,0]


#Data from the experiment
width=1.0     #width (cross-section coordinate Y)
depth=1.5     #depth (cross-section coordinate Z)
...
#analisis= predefined_solutions.simple_newton_raphson(problem)  ##!!!DOESN'T WORK WITH concrete02
