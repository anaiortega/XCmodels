...
qg.display_eigen_result(preprocessor,eigenMode=2, setToDisplay=setTotal,unitsScale=1.0,equLoadVctScale=0.0001,vtk_graphic_base.CameraParameters('XYZPos'),caption= '',fileName=None,defFScale=1.0)
