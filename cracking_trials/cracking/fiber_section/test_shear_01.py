...
reinforcementInf.p1= geom.Pos2d(cover-width/2.0,cover-depth/2.0) # Bottom reinforcement.
...
concreteSectionShearDesignParameters= EHE_limit_state_checking.ShearController('ULS_shear')
...
scc= ele1.getSection()
concreteSectionShearDesignParameters.calcVuEHE08(scc,"",EHE_materials.HA25,EHE_materials.B500S,NDato,math.sqrt(MyDato**2+MzDato**2),0,0)


Vu2A= concreteSectionShearDesignParameters.Vu2
...
concreteSectionShearDesignParameters.calcVuEHE08(scc,"",EHE_materials.HA25,EHE_materials.B500S, 0,0,0,0)

Vu2B= concreteSectionShearDesignParameters.Vu2
...
Vu2C= concreteSectionShearDesignParameters.Vu2
