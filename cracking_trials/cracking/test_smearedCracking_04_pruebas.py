...
A_s=5310e-6    #area of bottom reinforcement layer (10 fi 26)
...
concrFibEl1=setsRCEl1.concrFibers.fSet
reinfFibEl1=setsRCEl1.reinfFibers.fSet
...
heffmax_EHE=min(depth-x,depth/2.0)
Aceff_EHE_net=sccEl1.getNetEffectiveConcreteArea(heffmax_EHE,'reinfSetFbEl1',15.0)
...
print 'fiber \n'
sigmaLst=list()
matF=fConcrMin.getMaterial()
for eps in epsLst:
  matF.setTrialStrain(eps, 0.0)
  matF.commitState()
  sigmaLst.append([eps,matF.getStress()*1e-6])
