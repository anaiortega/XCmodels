...
trSup_020L2=[20,100]   #transversal superior sobre pila (excepto riostra) a
                       #0.20 x luz vano 2
...
lnSup_ref_loscart_Rpil=[16,100] #refuerzo longitudinal superior losa y cart. riostra pila
lnSup_ref_loscart_020L2=[16,100] #refuerzo longitudinal superior losa y cart.
...
lnInf_ref_los_L2=[20,200]  #refuerzo longitudinal inferior losa vano 2
...
lnSup_vol_020L2=[16,200] #longitudinal superior voladizo sobre pila a
                         #0.20 x luz vano 2
...
nramas_m=3 #nº ramas por m en sección transversal
diam_cercos=16
