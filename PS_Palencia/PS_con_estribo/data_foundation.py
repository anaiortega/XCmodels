...
(struts,ties)=gen_pile_found_1column_4piles(preprocessor=prep,nodCol=nPil,distXpile=distXpile,distYpile=distYpile,Hpilecap=Hpilecap,nameSetStruts='struts',nameSetTies='ties')
