...
lnSup_base_loscart_Rpil=[16,100] #base longitudinal superior losa y cart. riostra pila (se extiende a 0.20xL1 y 0.20*L2) 
lnSup_ref_loscart_Rpil=[20,100] #refuerzo longitudinal superior losa y cart. riostra pila  
lnSup_ref_loscart_020L2=[20,100] #refuerzo longitudinal superior losa y cart.
...
lnSup_vol_020L2=[12,100] #longitudinal superior voladizo sobre pila a
                         #0.20 x luz vano 2
