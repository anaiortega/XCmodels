...
for st in setsToDisplay:
    qg.displayLocalAxes(prep=prep,setToDisplay=st,vectorScale=vScale,vtk_graphic_base.CameraParameters('XYZPos'),caption=st.description.capitalize() + ', '+  capTexts['LocalAxes'],fileName=None,defFScale=0.0)
