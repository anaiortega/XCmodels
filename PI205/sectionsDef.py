...
DeckExtSlabRCSect= element_section_map.RCSlabBeamSection('deckExtSlabRCSect',"underpass.",concrete, reinfSteel,0.55)
...
DeckIntSlabRCSect= element_section_map.RCSlabBeamSection('deckIntSlabRCSect',"underpass.",concrete, reinfSteel,0.5)
#[0]: transversal rebars
#[1]: longitudinal rebars
...
FoundExtSlabRCSect= element_section_map.RCSlabBeamSection(name='foundExtSlabRCSect',sectionDescr="underpass.",depth=0.60,concrType=concrete, reinfSteelType=reinfSteel)
#[0]: transversal rebars
#[1]: longitudinal rebars
